...
Add CSS [uppy.min.css](https://transloadit.edgly.net/releases/uppy/v0.27.6-alpha.0/dist/uppy.min.css), either to `<head>` of your HTML page or include in JS, if your bundler of choice supports it — transforms and plugins are available for Browserify and Webpack.
...
```html
<!-- 1. Add CSS to `<head>` -->
<link href="https://transloadit.edgly.net/releases/uppy/v0.27.6-alpha.0/dist/uppy.min.css" rel="stylesheet">

<!-- 2. Add JS before the closing `</body>` -->
<script src="https://transloadit.edgly.net/releases/uppy/v0.27.6-alpha.0/dist/uppy.min.js"></script>
